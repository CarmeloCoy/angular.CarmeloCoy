...
3. **Brainstorming**: Discuss ideas, suggest features, explore alternatives, and collaborate on solutions
...
2. **Identify the approach**: Determine if this is code analysis or brainstorming
3. **Explore/research**: Use glob, grep tools as appropriate
